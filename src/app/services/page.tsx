      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-secondary-900 mb-4">Marketing & Client Acquisition</h2>
            ...
            <div className="bg-secondary-50 rounded-lg p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-secondary-900">Client Acquisition</h3>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <h2 className="text-3xl font-bold text-secondary-900 mb-4">Revenue Optimization</h2>
              <p className="text-secondary-600 mb-6">
            ...
            <div className="lg:order-1 bg-secondary-50 rounded-lg p-8">
              <div className="text-center">
                <div className="w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-10 h-10 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-xl font-semibold text-secondary-900">Revenue Growth</h3>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-secondary-900 mb-4">Operations & Scaling</h2>
              <p className="text-secondary-600 mb-6">
            ...
            <div className="bg-secondary-50 rounded-lg p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-secondary-900">Scalable Operations</h3>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2">
              <h2 className="text-3xl font-bold text-secondary-900 mb-4">AI & Tech Implementation</h2>
              <p className="text-secondary-600 mb-6">
            ...
            <div className="lg:order-1 bg-secondary-50 rounded-lg p-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-secondary-900">Smart Technology</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 bg-secondary-50 rounded-lg p-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-center">
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl font-bold text-primary-600 mb-1">$3K-$10K</div>
              <div className="text-sm text-secondary-600">Monthly Retainers</div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl font-bold text-primary-600 mb-1">$1.5K-$5K</div>
              <div className="text-sm text-secondary-600">One-off Projects</div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="text-2xl font-bold text-primary-600 mb-1">35-40%</div>
              <div className="text-sm text-secondary-600">Target ROI</div>
            </div>
          </div>
