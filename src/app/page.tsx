        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-8 rounded-lg bg-secondary-50 hover:bg-secondary-100 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-secondary-900 mb-2">Marketing & Client Acquisition</h3>
              <p className="text-secondary-600">Social media strategy, paid advertising, and lead generation systems</p>
            </div>
            ...
            <div className="text-center p-8 rounded-lg bg-secondary-50 hover:bg-secondary-100 transition-colors">
              ...
              <p className="text-secondary-600">Customer journey mapping, upsell/cross-sell strategies, and loyalty programs</p>
            </div>
            ...
            <div className="text-center p-8 rounded-lg bg-secondary-50 hover:bg-secondary-100 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-secondary-900 mb-2">Operations & Scaling</h3>
              <p className="text-secondary-600">Process optimization, SOPs, and hiring/training systems</p>
            </div>
            ...
            <div className="text-center p-8 rounded-lg bg-secondary-50 hover:bg-secondary-100 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-secondary-900 mb-2">AI & Tech Implementation</h3>
              <p className="text-secondary-600">Automation, AI-assisted marketing, and efficiency tools</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-secondary-600 mb-6">
                We specialize in helping small to mid-sized service businesses achieve sustainable growth through proven systems and strategies.
              </p>
